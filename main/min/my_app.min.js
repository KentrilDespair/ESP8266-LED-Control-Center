...
{case 0:app.request({method:"PUT",url:"/ind?led="+param1+"&state="+param2});break;case 1:app.request({method:"PUT",url:"/one?speed="+param1});break;case 2:app.request({method:"PUT",url:"/row?speed="+param1+"&pos="+param2});break;case 3:app.request({method:"PUT",url:"/col?speed="+param1+"&pos="+param2});break;case 4:app.request({method:"PUT",url:"/cir?speed="+param1+"&len="+param2+"&dir="+param3});break;case 5:app.request({method:"PUT",url:"/swp?speed="+param1});break;case 6:app.request({method:"PUT",url:"/arw?speed="+param1+"&pos="+param2});}}
...
chbx[1].onchange=function(){if(chbx[1].checked){click_arr[0]=1;}else{click_arr[0]=0;}
if(tgls[0].checked){send_seq(0,1,click_arr[0]);}}
chbx[2].onchange=function(){if(chbx[2].checked){click_arr[1]=1;}else{click_arr[1]=0;}
if(tgls[0].checked){send_seq(0,2,click_arr[1]);}}
chbx[3].onchange=function(){if(chbx[3].checked){click_arr[2]=1;}else{click_arr[2]=0;}
if(tgls[0].checked){send_seq(0,3,click_arr[2]);}}
chbx[4].onchange=function(){if(chbx[4].checked){click_arr[3]=1;}else{click_arr[3]=0;}
if(tgls[0].checked){send_seq(0,4,click_arr[3]);}}
chbx[5].onchange=function(){if(chbx[5].checked){click_arr[4]=1;}else{click_arr[4]=0;}
if(tgls[0].checked){send_seq(0,5,click_arr[4]);}}
chbx[6].onchange=function(){if(chbx[6].checked){click_arr[5]=1;}else{click_arr[5]=0;}
if(tgls[0].checked){send_seq(0,6,click_arr[5]);}}
chbx[7].onchange=function(){if(chbx[7].checked){click_arr[6]=1;}else{click_arr[6]=0;}
if(tgls[0].checked){send_seq(0,7,click_arr[6]);}}
chbx[8].onchange=function(){if(chbx[8].checked){click_arr[7]=1;}else{click_arr[7]=0;}
if(tgls[0].checked){send_seq(0,8,click_arr[7]);}}
chbx[9].onchange=function(){if(chbx[9].checked){click_arr[8]=1;}else{click_arr[8]=0;}
